...
y <- read_sgf(system.file("testdata/ko.sgf", package = "gogamer"))
kifu(y, 1, 108) %>% plot()
```
...
z <- read_sgf(system.file("testdata/ko9.sgf", package = "gogamer"))
kifu(z) %>% plot()
```
...
## Partial board
```{r, fig.width=5, fig.height=5}
a <- read_sgf(system.file("testdata/tsumego1.sgf", package = "gogamer"))
b <- read_sgf(system.file("testdata/tsumego2.sgf", package = "gogamer"))
d <- read_sgf(system.file("testdata/joseki.sgf", package = "gogamer"))
```
