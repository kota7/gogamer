...
#### Experiment
```{r, fig.width=5, fig.height=0.96}
# fig.width=5, fig.height=0.96
a <- kifu(z) %>% gogamer:::kifunote()
a
attr(a, "graphic_param")$endogenous$notestonesize
```

```{r, fig.width=5, fig.height=0.96}
# fig.width=5, fig.height=0.96
b <- kifu(z) %>% gogamer:::kifunote(adjustsizeonnote = TRUE, moveperrow = 4)
b
attr(b, "graphic_param")$endogenous$notestonesize
```
